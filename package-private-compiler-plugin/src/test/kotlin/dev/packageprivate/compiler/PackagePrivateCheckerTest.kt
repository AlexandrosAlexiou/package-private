...
class PackagePrivateCheckerTest {
    ...
    fun `no warning when @PackagePrivate on member of non-annotated class`() {
        ...
        assertEquals(
            false,
            result.messages.contains("Redundant"),
    ...
    fun `JVM bytecode sets package-private visibility on function`() {
        ...
        assertEquals(
            true,
            java.lang.reflect.Modifier.isPublic(publicMethod.modifiers),
            "publicMethod() should remain public",
        )
        ...
        assertEquals(
            false,
            java.lang.reflect.Modifier.isPublic(secretMethod.modifiers),
    ...
    fun `JVM bytecode sets package-private visibility on property`() {
        ...
        assertEquals(
            true,
            java.lang.reflect.Modifier.isPublic(publicGetter.modifiers),
        ...
        assertEquals(
            false,
            java.lang.reflect.Modifier.isPublic(secretGetter.modifiers),
